(function () {
    ...
    snooker.events.Ball = (function () {
        ...
        var collision_handler = function (area) {
            ...
            for (var i = 0; i < x_y_array.length; ++i) {
                ...
                for (var j = i + 1; j < x_y_array.length; ++j) {
                    ...
                    if (sqrt <= el.obj.offsetWidth / 2 + newel.obj.offsetWidth / 2) {
                        ...
                        var childToDelete = pklib.dom.by_id(elErr.obj.id),
                        ...
                        var scallEl = pklib.dom.by_id(elOK.obj.id);
        ...
        return {
            init: function (table, ball) {
                if (pklib.dom.is_element(ball)) {
                    collision_handler(table);

                    var hisL = null,
                        hisT = null,
                        histTimer = null,

                        _ball = pklib.dom.by_id(ball.id),
